<?php
  ...
  <label for="name" style="marging-left: 10px; color:#000; font-size:20px" >CATALOGO DE SERVICIO TECNICO:</label>
  <hr><hr>
   
      <div class="div_st">
          <label for="name" style="marging-left:10px; color:#000; font-size:14px" >Problema:</label>
